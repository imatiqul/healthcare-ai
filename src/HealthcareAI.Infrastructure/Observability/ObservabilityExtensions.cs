...
namespace HealthcareAI.Infrastructure.Observability;
        ...
        services.AddOpenTelemetry()
            ...
            .WithMetrics(m =>
            {
                m.AddAspNetCoreInstrumentation()
                    ...
                    .AddMeter("HealthcareAI.VoiceService")
                    .AddMeter("HealthcareAI.AgentService")
                    .AddMeter("HealthcareAI.FhirService")
                    .AddMeter("HealthcareAI.SchedulingService")
                    .AddMeter("HealthcareAI.OcrService")
                    .AddMeter("HealthcareAI.NotificationService")
                    .AddMeter("HealthcareAI.PopulationHealthService")
