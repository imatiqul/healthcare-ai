...
Shared domain layer containing all DDD primitives, aggregate roots, value objects, and domain events for every bounded context in the Healthcare AI platform.
...
| **CI/CD** | Built as part of `dotnet build HealthcareAI.sln` |

## Usage

```csharp
// Reference from any microservice .csproj
<ProjectReference Include="..\HealthcareAI.Domain\HealthcareAI.Domain.csproj" />
