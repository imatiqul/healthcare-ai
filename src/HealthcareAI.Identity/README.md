# HealthcareAI.Identity

Authentication and authorization microservice for the Healthcare AI platform. Manages user accounts, practitioner profiles, and Entra ID integration.
