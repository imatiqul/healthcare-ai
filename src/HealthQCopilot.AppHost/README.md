# HealthQCopilot.AppHost

Microsoft Aspire orchestration project that launches the entire HealthQ Copilot platform — all 8 microservices, databases, caches, and third-party containers — with a single `dotnet run`.
