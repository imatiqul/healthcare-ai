...
- Name: shell-navigation.spec.ts >> Shell App — Cloud Navigation >> shell loads and shows the dashboard
- Location: e2e-cloud\shell-navigation.spec.ts:4:7
...
Expected pattern: /HealthQ/i
Received string:  "Healthcare AI Platform"
Timeout: 5000ms

Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    9 × unexpected value "Healthcare AI Platform"
