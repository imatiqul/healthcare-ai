...
- Name: shell-navigation.spec.ts >> Shell App — Cloud Navigation >> can navigate to voice page
- Location: e2e-cloud\shell-navigation.spec.ts:21:7
...
Call log:
  - waiting for getByText('Voice Sessions')
