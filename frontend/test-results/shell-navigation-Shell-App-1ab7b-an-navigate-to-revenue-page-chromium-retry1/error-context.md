...
- Name: shell-navigation.spec.ts >> Shell App — Cloud Navigation >> can navigate to revenue page
- Location: e2e-cloud\shell-navigation.spec.ts:45:7
...
Call log:
  - waiting for getByText('Revenue Cycle')
